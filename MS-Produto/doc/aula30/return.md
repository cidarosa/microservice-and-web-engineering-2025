...
return (
    <Box sx={{ mt: 2, p: 4 }}>
      {/* 1. MENSAGENS GLOBAIS DE SUCESSO E ERRO PÓS-SUBMIT */}
      {success && (
        <Alert severity="success" sx={{ mb: 2 }}>
          {success}
        </Alert>
      )}
      {/* O Alert de erro PÓS-SUBMIT DEVE SER SEPARADO do erro de carregamento. */}
      {/* O erro PÓS-SUBMIT não é o mesmo que bloqueia a tela. */}
      ...
      ) : error ? ( // 2. ERRO DE CARREGAMENTO INICIAL (BLOQUEIA O FORMULÁRIO)
        ...
        <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
          ...
          >
            ...
            <Select
              ...
              name="categoriaId"
              value={
                formData.categoriaId === "" ? "" : String(formData.categoriaId)
